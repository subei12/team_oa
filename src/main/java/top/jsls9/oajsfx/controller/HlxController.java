...
public class HlxController {
    ...
    private static Logger logger = Logger.getLogger(HlxController.class);
    ...
    public RespBean settlement(@PathVariable("postId") String postId) throws IOException, ParseException {
        //获得当前登录用户名
        Subject subject = SecurityUtils.getSubject();
        String principal = (String) subject.getPrincipal();
        //查询登录用户信息
        ...
        //结算
        RespBean settlement = (RespBean) hlxService.settlement(user.getHlxUserId(), postId);
